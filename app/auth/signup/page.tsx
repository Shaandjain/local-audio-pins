  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 relative">
      ...
      >
        ...
        <p className="text-sm text-gray-500 mb-8">Start dropping audio pins around the world</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="name" className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">
              Name
            </label>
            <input
              id="name"
        ...
        <p className="mt-6 text-center text-sm text-gray-500">
          ...
          <Link href="/auth/signin" className="font-semibold text-gray-900 hover:underline">
            Sign in
          </Link>
        </p>
      </motion.div>
